    ...
    <div style={{ marginTop: 24, maxWidth: 640 }}>
      ...
      {open && (
        <div style={{ marginTop: 12, padding: "16px 18px",
          background: C.surface, border: `1px solid ${C.border}`,
          borderRadius: 6 }}>
          <div style={{ fontSize: 11, color: C.textMuted, lineHeight: 1.7, marginBottom: 16,
            fontStyle: "italic" }}>
          ...
          {sources.map((s) => (
            <div key={s.company} style={{ marginBottom: 18 }}>
              ...
              {s.note && (
                <div style={{ fontSize: 10, color: C.textMuted, lineHeight: 1.6, marginBottom: 8, paddingLeft: 18 }}>
                  {s.note}
                </div>
              )}
                ...
                {s.sources.map((src, i) => (
                  <div key={i} style={{ display: "flex", gap: 10 }}>
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: 10, color: C.textMuted }}>{src.detail}</span>
                    </div>
                  </div>
                ))}
              </div>
