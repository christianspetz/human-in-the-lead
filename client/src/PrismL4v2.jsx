...
<div style="text-align:center;padding:20px;font-size:10px;color:#888;border-top:1px solid #E0DDD6;margin-top:40px">
  ...
  const generatePhase0Report = () => {
    ...
    <div style="margin-top:40px;padding-top:16px;border-top:2px solid #eee;text-align:center;font-size:11px;color:#aaa">
      Generated by PrismL4 · Tech2Value — SAP S/4HANA & Joule Studio · humaninthelead.ai
    </div>
    </body></html>`;
    const blob = new Blob([html], { type: "text/html;charset=utf-8;" });
    const link = document.createElement("a");
  ...
  return (
    <div style={{ minHeight: "100vh", background: t.bg, color: t.tx, fontFamily: FONT, display: "flex", flexDirection: "column" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ display: "flex", gap: 2, marginBottom: 12, borderBottom: `1px solid ${t.bdr}` }}>
                        {[
                          ...
                          { key: "manual", label: "KPI Baseline", color: GREEN },
                        ].map(tab => (
                      ...
                      {/* KPI Baseline Tab — Inline KPI baseline entry */}
                      {step2Tab === "manual" && (
                        <div>
                      ...
                      {!hasFinancials && !financialsEntryMode && (
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                          ...
                          <div onClick={() => setFinancialsEntryMode("manual")} style={{ ...cardStyle, padding: "20px 16px", cursor: "pointer", textAlign: "center", border: `1px dashed ${GOLD}44` }}>
                            <div style={{ fontSize: 24, marginBottom: 8 }}>⌨</div>
                            <div style={{ fontSize: 13, fontWeight: 700, color: t.tx, marginBottom: 4 }}>KPI Baseline</div>
                      ...
                      {financialsError && !financialsExtracting && (
                        <div style={{ padding: "12px 16px", background: RED + "12", border: `1px solid ${RED}33`, borderRadius: 8, marginBottom: 12 }}>
                          ...
                          <div style={{ marginTop: 8, display: "flex", gap: 8 }}>
                            ...
                            <button onClick={() => { setFinancialsError(null); setFinancialsEntryMode("manual"); }} style={{ fontSize: 11, padding: "4px 12px", borderRadius: 6, background: "transparent", border: `1px solid ${t.bdr}`, color: t.tx2, cursor: "pointer", fontFamily: FONT }}>KPI Baseline</button>
                          </div>
                        </div>
                      )}
                  ...
                  <div key={proc.id} style={{ ...cardStyle, borderLeft: `3px solid ${proc.l1Color}` }}>
                    ...
                    <div style={{ display: "flex", gap: 2, marginBottom: 12, borderBottom: `1px solid ${t.bdr}` }}>
                      {[
                        ...
                        { key: "benchmarks", label: "③ S/4HANA Benchmarks", color: GREEN },
                      ].map(tab => (
      ...
      <div style={{ borderTop: `1px solid ${t.bdr}`, background: mode === "dark" ? "#131312" : "#EFEBE3", padding: "6px 24px", display: "flex", alignItems: "center", gap: 10, flexShrink: 0, flexWrap: "wrap" }}>
        ...
        <span style={{ fontSize: 10, color: t.sub }}>Tech2Value — SAP S/4HANA & Joule Studio</span>
        <div style={{ flex: 1 }} />
